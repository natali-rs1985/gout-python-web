...
def add_address(name):
    ...
    a.data[name].add_address(address_dict)
...
exec_command = {
    ...
    "show all notes": [show_notes, "show all notes:     Print all the records of address book, page by page", 0],
